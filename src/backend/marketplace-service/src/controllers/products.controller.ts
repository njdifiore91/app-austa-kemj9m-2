...
import { UserRole } from "@austa/shared/interfaces/user.interface"
...
export class ProductsController {
  ...
  async createProduct(
    ...
    try {
      ...
      const product = await this.marketplaceService.createProduct(
        productData,
        providerId
      )
  ...
  async getProductsByCategory(
    ...
    try {
      ...
      const products =
        await this.marketplaceService.getProductsByCategory(category)
  ...
  async getProductsByProvider(
    ...
    try {
      ...
      // Fetch products with security context
      const products =
        await this.marketplaceService.getProductsByProvider(providerId)
