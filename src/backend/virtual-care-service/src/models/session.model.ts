...
import { IUser, UserRole } from "@austa/shared/interfaces/user.interface"
...
interface ISessionDocument extends Document, ISession {
...
const createSessionSchema = (): Schema => {
  ...
  sessionSchema.methods.validateParticipants = function (
    this: ISessionDocument
  ): boolean {
    return this.participants.every((participant: ISessionParticipant) => {
      return participant.userId && participant.role && participant.joinedAt
    })
  }
