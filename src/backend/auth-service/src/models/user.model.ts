...
export interface IUserDocument
  extends Omit<IUser, "id">,
    Document,
    IUserMethods {
  id: string // Re-declare id to match Document's id type
}
 ...
 */
UserSchema.methods.updateAuditTrail = async function (
  event: AuditEvent
): Promise<void> {
 ...
 */
UserSchema.methods.validatePermissions = async function (
